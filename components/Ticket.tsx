...
export default function Ticket({ ticket, number, children }: TicketProps) {
  ...
  return (
    <article className='group grid gap-5 rounded-2xl border border-zinc-200 bg-white p-5 transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-zinc-300 hover:shadow-[0_12px_32px_-20px_rgba(0,0,0,0.35)] sm:p-6 md:grid-cols-[minmax(0,1fr)_16rem] md:items-center md:gap-8'>
