              ...
              <li key={cardIndex}>
                <article className='group rounded-2xl border border-zinc-200 bg-white p-5'>
                  <div className='min-w-0'>
                    <div className='mb-3 flex flex-wrap items-center gap-2.5'>
                      <div className='flex flex-col items-start gap-1.5'>
                        ...
                        <div className='flex items-center gap-1.5'>
                          ...
                          <span className='h-[26px] w-24 animate-pulse rounded-md border border-zinc-200 bg-zinc-50' />
                        </div>
                      </div>
                      <div className='flex items-center gap-1.5'>
                        <span className='size-3.5 animate-pulse rounded bg-zinc-100' />
                    ...
                    <span className='block h-6 w-4/5 animate-pulse rounded bg-zinc-100' />
                    <span className='mt-1.5 block h-6 w-full animate-pulse rounded bg-zinc-100' />
                    <span className='block h-6 w-3/5 animate-pulse rounded bg-zinc-100' />
                    <span className='block h-4 w-14 animate-pulse rounded bg-zinc-100' />
